    ...
    <section>
        ...
        <h2>Tabela Fipe do seu carro</h2>
          <form action="resultado.php" method='post'>
            <label for='exampleDataList' class='form-label'>Selecione o ano do carro</label>
            <select class='form-select form-select-md mb-3' aria-label='.form-select-lg example' name='ano'>
              <?php
                $resultado = getFipe($step, $marca, $carro);
